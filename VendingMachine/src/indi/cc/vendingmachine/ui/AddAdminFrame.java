    ...
    private void initComponents() {
        ...
        jButton1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(username.equals("")){
					JOptionPane.showMessageDialog(jd, "ユーザー名は空にできません！！");
					return ;
				}else if(password.equals("")){
					JOptionPane.showMessageDialog(jd, "パスワードは空にできません！！");
					return ;
				}else if(rePassword.equals("")){
					JOptionPane.showMessageDialog(jd, "パスワード確認は空にできません！！");
					return ;
				}else if(!password.equals(rePassword)){
					JOptionPane.showMessageDialog(jd, "2回入力したパスワードは一致していないです！");
					return ;
				}else {
					Administrator admin = new Administrator(username, password);
					AdminManageHelper manageHelper = new AdminManageHelper();
					if(manageHelper.addAdmin(admin)){
						JOptionPane.showMessageDialog(jd, "作成できました！！");
						jd.dispose();
						return ;
					}else{
