...
public class DrinkManageFrame extends JDialog {
	...
	private Administrator admin;
	    ...
	    private void initComponents() {
	        ...
	        jButton4.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(count<=0){
						JOptionPane.showMessageDialog(jd, "もう一番最初の項目です！");
						return ;
					}else{
						count--;
						updateContent();
	       ...
	       jButton5.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(count>=drinks.size()-1){
					JOptionPane.showMessageDialog(jd, "もう一番最後の項目です！");
					return ;
				}else{
					count++;
					updateContent();
	        ...
	        jButton6.setText("商品の情報を変更");
	       jButton6.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				UpdateDrinkFrame drinkFrame = new UpdateDrinkFrame(jd, "商品の情報を変更", true, drinks.get(count));
	        ...
	        jButton7.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(helper.deleteDrink(drinks.get(count))){
						JOptionPane.showMessageDialog(jd, "削除できました！！");
						drinks = helper.getAllDrink();	//更新所有饮料
						if(count==0){	//删除的是第一条
							//不需要改变
						}else{	//其他情况
						...
						JOptionPane.showMessageDialog(jd, "削除できませんでした！！");
						return ;
					}
        ...
        jButton1.setText("新しい商品を追加");
        jButton1.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				AddDrinkFrame drinkFrame = new AddDrinkFrame(jd, "新しい商品を追加", true,admin);
				drinks = helper.getAllDrink();	//更新所有饮料
				updateContent();//更新状态
			}
		});
        ...
        jButton2.setText("当商品を補充");
        jButton2.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				AddQuantityDrinkFrame drinkFrame = new AddQuantityDrinkFrame(jd, "補充"+drinks.get(count).getDrinkName()+"商品", true,drinks.get(count),admin);
				updateContent();//更新状态
			}
		});
	    ...
	    private void updateContent(){
	    	...
	    	jTextField3.setText(drinks.get(count).getPrice()+"円");
	    	jTextField4.setText(drinks.get(count).getQuantity()+"個");
