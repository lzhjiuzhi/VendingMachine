...
public class AdminChoose extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("管理員："+admin.getUsername());
        setBackground(new java.awt.Color(255, 255, 255));

        jButton1.setFont(new java.awt.Font("幼圆", 1, 12)); // NOI18N
        jButton1.setText("新しい管理員を追加");
        jButton1.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				AddAdminFrame addAdminFrame = new AddAdminFrame(jf, "新しい管理員を追加", true);
			}
		});

        jButton2.setFont(new java.awt.Font("幼圆", 1, 12)); // NOI18N
        jButton2.setText("パスワードを変更");
        jButton2.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				UpdatePasswordFrame frame = new UpdatePasswordFrame(jf, "パスワードを変更", true,admin);
			}
		});

        jButton4.setFont(new java.awt.Font("幼圆", 1, 12)); // NOI18N
        jButton4.setText("金額を管理");
        jButton4.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				CashManageFrame frame = new CashManageFrame(jf, "金額を管理", true,admin);
			}
		});
        
        
        jButton5.setFont(new java.awt.Font("幼圆", 1, 12)); // NOI18N
        jButton5.setText("履歴を表示");
        jButton5.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				RecordsManageFrame frame = new RecordsManageFrame(jf, "履歴を表示", true);
			}
		});
        ...
        jButton3.setText("商品を管理");
        jButton3.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				DrinkManageFrame drinkManage = new DrinkManageFrame(jf, "商品を管理", true,admin);
			}
		});
