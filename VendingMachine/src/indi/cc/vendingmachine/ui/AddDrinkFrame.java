...
public class AddDrinkFrame extends javax.swing.JDialog {
    ...
    private void initComponents() {
    	this.jd = this;
        jButton1 = new javax.swing.JButton("画像を追加");
        ...
        jButton2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(id.equals("")){
					JOptionPane.showMessageDialog(jd, "番号は空にできません！！");
					return ;
				}else if(name.equals("")){
					JOptionPane.showMessageDialog(jd, "商品の名前は空にできません！！");
					return ;
				}else if(price.equals("")){
					JOptionPane.showMessageDialog(jd, "価額は空にできません！！");
					return ;
				}else if(filepath==null){
					JOptionPane.showMessageDialog(jd, "画像を追加してください！！");
					return ;
				}else{
					...
					if(Tools.copy(filepath, filename)){
						...
						if(manageHelper.addDrink(drink)){
							JOptionPane.showMessageDialog(jd, "追加できました！！");		
							jd.dispose();
							return ;
						}else {
							JOptionPane.showMessageDialog(jd, "追加できませんでした！！");
							jd.dispose();
							return ;
						}
					}else{
