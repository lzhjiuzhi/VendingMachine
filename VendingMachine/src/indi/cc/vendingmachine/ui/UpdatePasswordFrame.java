    ...
    private void initComponents() {
        ...
        jButton1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(oldPass.equals("")){
					JOptionPane.showMessageDialog(jd, "古いパスワードは空にできません！！");
					return ;
				}else if(newPass.equals("")){
					JOptionPane.showMessageDialog(jd, "新しいパスワードは空にできません！！");
					return ;
				}else if(rePass.equals("")){
					JOptionPane.showMessageDialog(jd, "パスワード確認は空にできません！！");
					return ;
				}else if(!newPass.equals(rePass)){
					JOptionPane.showMessageDialog(jd, "二回入力したパスワードは一致していません！！");
					return ;
				}else{
					...
					if(manageHelper.getAdmin(admin).getPassword().equals(oldPass)&&manageHelper.updatePassword(admin, newAdmin)){
						JOptionPane.showMessageDialog(jd, "変更できました！！");
						jd.dispose();
						return ;
					}else{
						JOptionPane.showMessageDialog(jd, "変更できませんでした！！");
						jd.dispose();
						return ;
					}
				}
