...
public class CashManageFrame extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton1.setText("金額を表示：");
        jButton1.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				AmountQuery amountQuery = new AmountQuery(jd, "金額を表示", true);
			}
		});
       

        jButton2.setFont(new java.awt.Font("幼圆", 1, 12)); // NOI18N
        jButton2.setText("細かいお金を補充");
        jButton2.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				AddCoinFrame addCoinFrame = new AddCoinFrame(jd, "細かいお金を補充", true,admin);
			}
		});

        jButton3.setFont(new java.awt.Font("幼圆", 1, 12)); // NOI18N
        jButton3.setText("お金を引き出し");
       jButton3.addActionListener(new ActionListener() {
		
		@Override
		public void actionPerformed(ActionEvent arg0) {
			// TODO Auto-generated method stub
			 int option = JOptionPane.showConfirmDialog(jd, "全部引き出し", "キャンセル", JOptionPane.YES_NO_OPTION);
			 if(option==JOptionPane.YES_OPTION){
				...
				// 添加取现记录
				 ...
				 if(totalAmount!=0){
					 ...
					 JOptionPane.showMessageDialog(jd, "引き出した金額は："+totalAmount+"円！！");	
					 record.setCash(totalAmount);
					 record.setAfterCash(0);
					 helper.addCashRecords(record);//添加取现记录

				 }else{
					 JOptionPane.showMessageDialog(jd, "引き出せるお金はありません。");
				 }
